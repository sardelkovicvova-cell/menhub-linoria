...
local BaseURL = "https://raw.githubusercontent.com/YOUR_USERNAME/MyLinoria/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    Cursor = {
        RobloxId = 9619665977,
        Path = "MyLinoria/assets/Cursor.png",
    ...
    DropdownArrow = {
        RobloxId = 6282522798,
        Path = "MyLinoria/assets/DropdownArrow.png",
    ...
    Checker = {
        ...
        Path = "MyLinoria/assets/Checker.png",
    ...
    CheckerLong = {
        ...
        Path = "MyLinoria/assets/CheckerLong.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "MyLinoria/assets/SaturationMap.png",
