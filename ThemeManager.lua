...
local ThemeManager = {} do
	...
	ThemeManager.Folder = "MyLinoriaSettings"
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['MenHub']        = { 1, { FontColor = "c8c8c8", MainColor = "121212", AccentColor = "919191", BackgroundColor = "0c0c0c", OutlineColor = "262626" } },
		['Default']       = { 2, { FontColor = "c8c8c8", MainColor = "121212", AccentColor = "919191", BackgroundColor = "0c0c0c", OutlineColor = "262626" } },
